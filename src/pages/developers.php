...
<head>
    ...
    <link rel="stylesheet" href="./developers-css/developers.css">
...
<body>
    ...
    <div class="developers-heading-section top-section">
        <div class="heading-developers">
            <h1> Meet the <span> Developers</span> </h1>
        </div>
    </div>

    <div class="developers-content-section">
        ...
        <div class="developers-sec-content">
            <div class="sec-content-para">
                <h2> <span>We are from </span> NSBM Green University</h2>
                ...
                <button onclick="location.href='https://www.nsbm.ac.lk';">Visit NSBM</button>
            </div>

            <div class="sec-content-img"></div>
        </div>
        <img src="./../../public/nsbmpic.jpg" class="nsbmPic" alt="nsbm">
